...
const config = {
  ...
  maintenanceCollection:
    process.env.EXPO_PUBLIC_APPWRITE_MAINTENENCE_COLLECTION_ID,
  ...
  expenseSlipsCollection:
    ...
    miscCollection: process.env.EXPO_PUBLIC_APPWRITE_MISC_COLLECTION_ID,
};
...
export { database, account, config, client, ID };
